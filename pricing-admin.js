...
(function(global) {
    ...
    const DEFAULT_PRICING = {
        ...
        plans: [
            { id: 'nano', name: 'Nano', price: 599, setup: 0, featured: false, description: 'For very small teams — Core Automation Nano, Appt Setting Nano, Pick ONE channel' },
            ...
            { id: 'starter', name: 'Starter', price: 1899, setup: 0, featured: true, description: 'Most popular — Core Automation Starter, Appt Setting Starter, PPC Starter + SEO Micro' },
            { id: 'pro', name: 'Pro', price: 3799, setup: 0, featured: false, description: 'Multi-service push or multi-location lite — Core Automation Pro, Appt Setting Pro' },
